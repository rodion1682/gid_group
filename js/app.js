...
if (isMobile.any()) {
	pageBody.classList.add('_touch');
} else {
	pageBody.classList.add('_mouse');
}



const toTopButton = document.querySelector('.footer__top');
...
if (projects) {
	...
	projects.addEventListener("click", function (e) {
		...
		if (targetElem.classList.contains('items-projects__btn')) {
	...
	async function getMoreQuestions(targetElem) {
		...
		if (response.ok) {
			...
			const helpItems = document.querySelector('.items-projects__body');
...
let headerLogoLink = document.querySelector('.header__logo');
let headerWrapper = document.querySelector('.header__wrapper');

if (pageBlock.classList.contains('_page--home')) {
	headerLogoLink.classList.add('_home');
	headerWrapper.classList.add('_home');
} else {
	headerLogoLink.classList.add('_another');
	headerWrapper.classList.add('_another');
	headerLogoLink.removeAttribute('data-da');
}
...
if (team) {
	...
	team.addEventListener("click", function (e) {
		const targetElem = e.target;
		if (targetElem.classList.contains('team__btn')) {
			if (!targetElem.classList.contains('_loading')) {
				targetElem.classList.add('_loading');
				getMoreQuestions(targetElem);
			}
	...
	async function getMoreQuestions(targetElem) {
		const response = await fetch('data/faq-team.html');
		if (response.ok) {
			const text = await response.text();
			const helpItems = document.querySelector('.team__items');
			helpItems.insertAdjacentHTML('beforeend', text);
			targetElem.classList.remove('_loading');
		} else {
			alert('Что-то пошло не так...');
...
if (surveyBody) {
	new Swiper(surveyBody, {
		...
		*/
		...
		// Dotts
		pagination: {
			el: '.navigation-survey__dots',
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.navigation-survey__arrow--next',
			prevEl: '.navigation-survey__arrow--prev',
		},
		// breakpoints: {
		// 	320: {
		// 		autoHeight: true,
...
const projectSurveySlider = document.querySelector('.project-survey__slider');

if (projectSurveySlider) {
	new Swiper(projectSurveySlider, {
		wrapperClass: "project-survey__body",
		slideClass: "project-survey__slide",
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.project-survey__arrow--next',
			prevEl: '.project-survey__arrow--prev',
		},
		breakpoints: {
			480: {
				spaceBetween: 15,
...
const sliderJobs = document.querySelector('.slider-jobs');

if (sliderJobs) {
	new Swiper(sliderJobs, {
		wrapperClass: "slider-jobs__body",
		slideClass: "slider-jobs__slide",
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-jobs__arrow--next',
			prevEl: '.slider-jobs__arrow--prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.1,
...
const sliderReview = document.querySelector('.slider-review__body');
// .slider-review

if (sliderReview) {
	new Swiper(sliderReview, {
		// wrapperClass: "slider-review__body",
		// slideClass: "slider-review__slide",
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-review__arrow--next',
			prevEl: '.slider-review__arrow--prev',
		},
		breakpoints: {
			320: {
				spaceBetween: 35,
